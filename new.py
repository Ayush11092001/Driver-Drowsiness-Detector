...
def main():
    ...
    if choice == "Home":
        ...
        if st.sidebar.checkbox("Login"):
            ...
            if result:
                ...
                if run == True:
                    pygame.mixer.init()
                    alarm_sound = pygame.mixer.Sound("D:/Driver-Drowsiness-Detector-master/audio/alarm.wav")
                    EYE_AR_THRESH = 0.3
                    ...
                    X1 = []
                    X2 = []
                    face_cascade = cv2.CascadeClassifier("D:\Driver-Drowsiness-Detector-master\haarcascade_frontalface_default.xml")
                    ...
                    predictor = dlib.shape_predictor("D:/Driver-Drowsiness-Detector-master/shape_predictor_68_face_landmarks.dat")
    ...
    # read data menu
        ...
        """, unsafe_allow_html=True)
        with col1:
            st.image("DD.png", width=800, caption="Safety is always the choice of every wise, because they don't close eyes, so be wise.")
